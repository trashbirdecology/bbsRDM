---
title: "An example of how to use the package to calculate and visualize multiple regime detection metrics using BBS data: spatial application"
...
# bbsRDM: A Package for Calculating Regime Detection Measures on the North American Breeding Bird Survey Data
...
**Note: depending on the # of years and spatial transects, this could take a while!**
```{r calcMetrics, eval=T}
...
We can visualize either the distance results (`distResults`) or the early-warning signal results (`ewsResults`).
...
**Note: please specify dirID.ind as desired spatial transect number, and dirInd as direction (E-W or N-S)**
