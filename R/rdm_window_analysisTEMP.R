#' @title THIS WAS BORROWED FROM REGIME DETECTION MEASURES PACKAGE AND WILL BE REMOVED SOON!!!
...
#' @export
rdm_window_analysisTEMP <- function(dataInRDM,
                                winMove = 0.25,
                                overrideSiteErr = F,
                                min.window.dat = 2,
                                fi.equation = '7.12',
  ...
  if (winMove > 1 | winMove < 0.00000000001) {
